...
public class BluePacman extends Pacman {
    ...
    public BluePacman(int x, int y,int viewDx,int viewDy,int lives){
        loadImage();
        this.dx=0;this.dy=0;
        this.x=x;this.y=y;
    ...
    public void loadImage() {
        pacman1= new ImageIcon("src/resources/images/pacman_blue.png").getImage();
        pacman2up= new ImageIcon("src/resources/images/up1_blue.png").getImage();
        pacman3up= new ImageIcon("src/resources/images/up2_blue.png").getImage();
        pacman4up= new ImageIcon("src/resources/images/up3_blue.png").getImage();
        pacman2down= new ImageIcon("src/resources/images/down1_blue.png").getImage();
        pacman3down= new ImageIcon("src/resources/images/down2_blue.png").getImage();
        pacman4down= new ImageIcon("src/resources/images/down3_blue.png").getImage();
        pacman2left= new ImageIcon("src/resources/images/left1_blue.png").getImage();
        pacman3left= new ImageIcon("src/resources/images/left2_blue.png").getImage();
        pacman4left= new ImageIcon("src/resources/images/left3_blue.png").getImage();
        pacman2right= new ImageIcon("src/resources/images/right1_blue.png").getImage();
        pacman3right= new ImageIcon("src/resources/images/right2_blue.png").getImage();
        pacman4right= new ImageIcon("src/resources/images/right3_blue.png").getImage();
    }
